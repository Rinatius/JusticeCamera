...
public class RegisterActivity extends AppCompatActivity
{
  ...
  private void initUI()
  {
      ...
      emailField = (EditText) findViewById( R.id.emailField );firstNameField = (EditText) findViewById( R.id.firstNameField );lastNameField = (EditText) findViewById( R.id.lastNameField );passportNoField = (EditText) findViewById( R.id.passportNoField );passwordField = (EditText) findViewById( R.id.passwordField );phoneNumberField = (EditText) findViewById( R.id.phoneNumberField );
